...
def _qz(A, B, output='real', lwork=None, overwrite_a=False,
...
def qz(A, B, output='real', lwork=None, overwrite_a=False,
       overwrite_b=False, check_finite=True):
    """
    ...
    result, _ = _qz(A, B, output=output, lwork=lwork,
...
def ordqz(A, B, sort='lhp', output='real', overwrite_a=False,
    ...
    """
    (AA, BB, _, *ab, Q, Z, _, _), typ = _qz(A, B, output=output,
